...
function onYouTubeIframeAPIReady() {
    player = new YT.Player('player', {
        height: (document.querySelector('.riga').offsetWidth / 1.8),
        width: document.querySelector('.riga').offsetWidth,
        videoId: 'hY7m5jjJ9mM',
        events: {
...
window.addEventListener('resize', () => {
    player.setSize(document.querySelector('.riga').offsetWidth, (document.querySelector('.riga').offsetWidth / 2))
})
